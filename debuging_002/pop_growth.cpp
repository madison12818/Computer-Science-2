...
int main(int argc, const char * argv[]) {
  ...
  char univName [STRING_SIZE]; // ERROR HERE (changed 10 to STRING_SIZE)
...
int calculatePopulation( int pop, int growth) {
  double growthRate = (double) growth / 100; // ERROR HERE (changed 10 to 100)
  double increase = (double) pop * growthRate;
  return (pop + increase); // ERROR HERE (changed * to +)
